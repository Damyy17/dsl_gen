...
public class GeneticsGrammarParser extends Parser {
	...
	public static final int
		...
		OR=31, CROSS_OPERATION=32, GENES=33, PARENT=34, GENERATION=35, DSLBOOLEAN=36, 
		DSLNUMBER=37, DSLSTRING=38, SET=39, DOM=40, PHENOTYPE=41, CODOMINANCE=42, 
		LOCATION=43, LABEL=44, GENOTYPE=45, FREQUENCY=46, PUNNET=47, VALUE=48, 
		FIND=49, CROSS=50, PRED=51, ESTIMATE=52, IF=53, THEN=54, ELSE=55, END=56, 
		WHILE=57, FOR=58, DO=59, ALL=60, PRINT=61;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'and'", "'or'", "'*'", "'genes'", "'parents'", "'generation'", "'boolean'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"IF", "THEN", "ELSE", "END", "WHILE", "FOR", "DO", "ALL", "PRINT"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << BIGALPHA) | (1L << SMALLALPHA) | (1L << NUMBER) | (1L << GENES) | (1L << PARENT) | (1L << GENERATION) | (1L << DSLBOOLEAN) | (1L << DSLNUMBER) | (1L << DSLSTRING) | (1L << SET) | (1L << DOM) | (1L << FIND) | (1L << CROSS) | (1L << PRED) | (1L << ESTIMATE) | (1L << IF) | (1L << WHILE) | (1L << FOR) | (1L << PRINT))) != 0) );
			setState(51);
			match(EOF);
			}
		}
